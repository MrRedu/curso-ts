;
(function () {
    var normalArray = ['String', 35, true]; // const normalArray: (string | number | boolean)[]
    // Los valores del array pueden ser string, number o boolean;
    //...la diferencia con las tuples...
    var normalTuple = ['String', 35, true]; // const normalTuple: [string, number, boolean]
    // ...la diferencia con las tuples...
    ...
    console.log({ normalArray: normalArray, normalTuple: normalTuple });
})();
